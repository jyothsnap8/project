<%@ Page Title="" Language="C#" MasterPageFile="~/jobseekermaster.master" AutoEventWireup="true" CodeFile="jobseeker_profile.aspx.cs" Inherits="jobseeker_profile" %>
 ...
 <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Large" 
   ...
   <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" 
            ...
            <Fields>
                ...
                <asp:BoundField DataField="contact_number" HeaderText="contact_no" 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ConnectionString="Data Source=DESKTOP-I5NO62R\SQLEXPRESS;Initial Catalog=jobportal1;Integrated Security=True" 
...
<asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="Large" 
   ...
   <asp:DetailsView ID="DetailsView2" runat="server" AutoGenerateRows="False" 
            ...
            <Fields>
                ...
                <asp:BoundField DataField="per_post_grad" HeaderText="Percentage" 
                    SortExpression="per_post_grad" />
                ...
                <asp:BoundField DataField="per_dr_phd" HeaderText="Percentage" 
                    SortExpression="per_dr_phd" />
